...
#---------------Version 20221008_v1.8---------------
# Fila 302 se pasó a NA
# lags ciclo for de 4
# canaritos_ratio = 0.3 después  del random forest
...
#kdirectortioexp       <- "./exp/"  #Directorio donde queda el experimiento
#kexperimento          <- "FE8150_20221002_v1"                       #Nombre del experimiento
#kdirectorioFE         <- paste0("./exp/", kexperimento)  #Directorio donde queda el experimiento
...
CorregirCampoMes  <- function( pcampo, pmeses )
{
  ...
  #n: integer vector denoting the offset by which to lead or lag the input. To create multiple lead/lag vectors, provide multiple 
  #values to n; negative values of n will "flip" the value of type, i.e., n=-1 and type='lead' is the same as n=1 and type='lag'.
...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[ cliente_antiguedad==3 , ctrx_quarter_normalizado := as.integer(ctrx_quarter * 1.2) ]
...
print("Termió Corregir_MarchineLearning- Empieza AgregarVariables")
#Agrego las variables manuales al dataset
AgregarVariables( dataset )


print("Termió AgregarVariables-  Empieza lags")
#--------------------------------------
...
print("Termió lags-  Empieza TendenciaYmuchomas")
#--------------------------------------
...
print("Termió AgregaVarRandomForest-  Empieza CanaritosAsesinos ")
