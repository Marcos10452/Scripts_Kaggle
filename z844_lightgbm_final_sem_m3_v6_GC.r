...
kexperimento         <- "KA8440_K100-M3_seed5_20%_v6"                       #Nombre del experimiento
...
for( semilla  in  ksemillas )
{
  ...
  #--------------------------------------------
  Contadro<<- Contador +1
  print((Contador/lng_semilla)*100)
